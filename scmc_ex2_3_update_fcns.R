...
update.all <- function(accepted = NULL, given = given,
  ...
  foreach(i = 1:N, .combine = "combine.particles", .inorder = TRUE,
    ...
    prob.sig2 <- sig2update$prob.sig2 # qqq
    sig2new <- sig2update$sig2new
    ...
    prob.ystarynew <- ystaryprimeupdate$prob  # qqq
    ...
    list(l = lcurrent,
         ...
         acceptances =
           cbind(accepted.l = accepted.l,
                 ...
                 prob.sig2 = prob.sig2, # qqq
                 sig2new = sig2new,
                 prob.ystarynew = prob.ystarynew,
                 ystar2old = ystar2old,
                 ystar2new = ystar2new,
