...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bigskip
\framebox[1.2\width]{$b_1 = b_2 = 0$} $\Rightarrow$ \texttt{"matern"/"sqexp"} 
...
\bigskip
\framebox[1.1\width]{$b_1 > 0, b_2 = 0$ or $b_1 = 0, b_2 > 0$} $\Rightarrow$ \texttt{"matern1"/"sqexp1"}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bigskip
\framebox[1.2\width]{$b_1, b_2 > 0$} $\Rightarrow$ \texttt{"matern2"/"sqexp2"}
